...
export function DecorativeBlobs() {
  return (
    <>
      ...
      <div
        className="absolute top-20 left-10 w-64 h-64 bg-gold/10 rounded-full blur-3xl pointer-events-none -z-10"
      />
      {/* Bottom right - wine undertone for warmth */}
      <div
        className="absolute bottom-10 right-10 w-80 h-80 bg-wine/5 rounded-full blur-3xl pointer-events-none -z-10"
      />
...
export function HeroBlobs() {
  return (
    <>
      <div
        className="absolute top-0 left-0 w-96 h-96 bg-gold/10 rounded-full blur-3xl pointer-events-none -z-10"
      />
      <div
        className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-wine/5 rounded-full blur-3xl pointer-events-none -z-10"
      />
    </>
  );
}
