...
export const metadata: Metadata = getPageMetadata({
  ...
  description:
    "Premium 1:1 transformation program with Disha Methi Khandelwal. 6 months of personal coaching, custom fitness & nutrition plans, beauty consultation, financial guidance, and VIP support. ₹1,20,000 investment for complete life transformation. Book your ₹1,999 strategy call today.",
  keywords: [
