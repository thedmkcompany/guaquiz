...
export const metadata: Metadata = getPageMetadata({
  ...
  description:
    "Join 100+ women in Circle - your transformation sisterhood. Live workouts 5x/week, 4-pillar system (fitness, beauty, finance, confidence), WhatsApp community, expert coaching. ₹3,499/month. Cancel anytime.",
  keywords: [
