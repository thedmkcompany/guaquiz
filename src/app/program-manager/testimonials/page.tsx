...
import TestimonialsList from "@/components/program-manager/TestimonialsList";
import { listTestimonials } from "@/lib/testimonials-store";

export default async function ProgramManagerTestimonialsPage() {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="rounded-2xl border border-[#cdbf9a] bg-[#fff8ea] p-6 sm:p-8 shadow-[0_12px_30px_rgba(0,0,0,0.08)]">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <span className="rounded-xl bg-[#7e0f1d] text-[#f7f3e8] px-4 py-2.5 text-sm font-semibold">Testimonials</span>
            <Link href="/program-manager/testimonials/new" className="rounded-xl border border-[#cdbf9a] bg-white px-4 py-2.5 text-sm text-[#123b34] hover:bg-[#f7f3e8]">
              Add New
            </Link>
            <Link href="/program-manager" className="rounded-xl border border-[#cdbf9a] bg-white px-4 py-2.5 text-sm text-[#123b34] hover:bg-[#f7f3e8]">
              Back to portal
            </Link>
          </div>
        </div>
