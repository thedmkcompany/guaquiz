...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      { source: "/results/webinar", destination: "/results/essentials", permanent: true },
    ];
  },
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "frame-src https://checkout.razorpay.com https://api.razorpay.com https://test.payu.in https://secure.payu.in https://calendly.com https://server-side-tagging-c4wk5cth4a-uc.a.run.app https://www.youtube.com https://www.youtube-nocookie.com",
